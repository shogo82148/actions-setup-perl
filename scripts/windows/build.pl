...
sub run {
    ...
    group "install common CPAN modules" => sub {
        ...
        # JSON::MaybeXS
        # EXCEPTION_ACCESS_VIOLATION with perl v5.11.1 - v5.11.5, v5.12.x and v5.13.0
        cpan_install('https://cpan.metacpan.org/authors/id/E/ET/ETHER/JSON-MaybeXS-1.004003.tar.gz', '5.6.0', '5.11.1');
        ...
        cpan_install('https://cpan.metacpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.068.tar.gz', '5.8.0', '5.11.1');
