...
sub run {
    ...
    group "install common CPAN modules" => sub {
        ...
        # Cpanel::JSON::XS
        # install fails with perl v5.13.3, v5.13.4, v5.13.5, v.5.13.6, v.5.13.7 and v.5.13.8
        cpan_install('https://cpan.metacpan.org/authors/id/R/RU/RURBAN/Cpanel-JSON-XS-4.25.tar.gz', '5.6.2', '5.13.3');
